...
renderDriverTransitHistory(container) {
      ...
      >
        ...
        <div class="start-trip-actions">
          ...
          >
            ...
            Share Live Safety Footprint via WhatsApp
  ...
  completeTrip() {
    ...
    if (modal) {
      ...
      if (title) {
        title.textContent =
          `You reached ${this.activeRoute.toName}! What did you pay?`;
      }
      ...
      if (submitBtn) {
        submitBtn.onclick = () => {
          ...
          if (
            ...
            this.activeRoute.last3PassengersPaid =
              this.activeRoute.last3PassengersPaid.slice(
                0,
                3
              );
          }
          ...
          alert(
            "🎉 Trip Completed! Your payment has been added to the 'Last 3 Passengers Paid' live ticker to protect the next traveler."
          );
        };
      }
    }
